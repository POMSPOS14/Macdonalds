...
public class FrontServlet extends HttpServlet {
    ...
    private void insertInitialData(ProductRepository productRepository) {
        productRepository.save(new ProductModel(0, "Burger 1", 100, 1, "https://burgerking.ru/images/product_images/mobile/cheezy-joe.png", Constants.BURGERS));
        productRepository.save(new ProductModel(0, "Burger 2", 200, 1, "https://burgerking.ru/images/product_images/mobile/cheezy-joe.png", Constants.BURGERS));
        productRepository.save(new ProductModel(0, "Drink 1", 120, 1, "https://psn42.ru/upload/iblock/ea8/ea8cd56d01748af7b157de3563670651.png", Constants.BURGERS));
        productRepository.save(new ProductModel(0, "Drink 2", 140, 1, "https://psn42.ru/upload/iblock/ea8/ea8cd56d01748af7b157de3563670651.png", Constants.BURGERS));
        productRepository.save(new ProductModel(0, "Desert 1", 900, 1, "https://img-fotki.yandex.ru/get/105980/161031371.217/0_181d8a_6c7ddca_L", Constants.BURGERS));
        productRepository.save(new ProductModel(0, "Desert 2", 200, 1, "https://img-fotki.yandex.ru/get/105980/161031371.217/0_181d8a_6c7ddca_L", Constants.BURGERS));
    }
        ...
        if (url.startsWith("/admin")) {
            if (url.equals("/admin")) {
                ...
                if (req.getMethod().equals("POST")) {
                    ...
                    // TODO: validation
                    burgerAdminService.save(new ProductModel(id, name, price, quantity, null, category));
